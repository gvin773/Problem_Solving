...
int main()
{
    ...
    while(tc--)
    {
        ...
        for(int i = 1; i <= n+1; i++)
        {
            Edge *e1= new Edge(i*2, i == start ? 2 : 1, 0), *e2 = new Edge(i*2-1, 0, 0);
            e1->dual = e2;
            e2->dual = e1;
        ...
        {
            cin >> a >> b;
            Edge *e1 = new Edge(b*2-1, 1, -1), *e2 = new Edge(a*2, 0, 1);
            e1->dual = e2;
            e2->dual = e1;
        ...
        for(int i = 1; i <= n; i++)
        {
            Edge *e1 = new Edge(i*2-1, 1, -1), *e2 = new Edge(start*2, 0, 1);
            e1->dual = e2;
            e2->dual = e1;

            adj[start*2].push_back(e1);
            adj[i*2-1].push_back(e2);
        }
        for(int i = 1; i <= n; i++)
        {
            Edge *e1 = new Edge(fin, 1, 0), *e2 = new Edge(i*2, 0, 0);
            e1->dual = e2;
            e2->dual = e1;
